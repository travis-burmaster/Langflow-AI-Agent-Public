...
export default function TestimonialsSection() {
  const testimonials = [
    { name: "Dr. Emily Chen", role: "Quantum Physics Researcher", quote: "This AI Agent has revolutionized my workflow. It's like having a team of experts at my fingertips 24/7, accelerating my research in ways I never thought possible." },
